          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/[0.03] border border-white/[0.06] rounded-xl flex items-center justify-center text-text-dim hover:text-[#4285f4] hover:border-[#4285f4]/20 transition-all duration-300"
