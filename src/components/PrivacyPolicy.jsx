        ...
        <div className="space-y-8 text-text-muted text-sm leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-white/[0.03] border border-border rounded-xl p-5 space-y-1">
              <p><strong className="text-text">Panificio Da Sergio</strong></p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-text-dim">
              <li><strong className="text-text/80">Nome e cognome</strong> — per la gestione degli ordini via WhatsApp</li>
              <li><strong className="text-text/80">Numero di telefono</strong> — per la comunicazione degli ordini</li>
              <li><strong className="text-text/80">Indirizzo email</strong> — per la newsletter (previo consenso esplicito) e conferma ordini</li>
            </ul>

            <h3 className="text-text font-semibold mt-4 mb-2">4.2 Dati di navigazione</h3>
            <ul className="list-disc list-inside space-y-1 text-text-dim">
              <li><strong className="text-text/80">Cookie tecnici</strong> — necessari al funzionamento del sito</li>
              <li><strong className="text-text/80">Cookie analitici</strong> — solo previo consenso dell'utente (Google Analytics)</li>
              <li><strong className="text-text/80">Pixel di tracciamento</strong> — solo previo consenso (Meta Pixel)</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-text-dim">
              <li><strong className="text-text/80">Dati degli ordini:</strong> conservati per il tempo necessario all'evasione dell'ordine e comunque non oltre 24 mesi</li>
              <li><strong className="text-text/80">Newsletter:</strong> fino alla revoca del consenso (disiscrizione)</li>
              <li><strong className="text-text/80">Cookie analitici:</strong> massimo 12 mesi</li>
              <li><strong className="text-text/80">Dati di navigazione:</strong> in forma aggregata e anonima</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 mt-3">
              ...
              <div className="bg-white/[0.03] border border-border rounded-xl p-4">
                <p className="text-text font-semibold text-sm">📱 Pixel di Tracciamento (solo con consenso)</p>
                <p className="mt-1 text-text-dim">
            ...
            <h3 className="text-text font-semibold mt-4 mb-2">7.4 Terze parti</h3>
            <p>I seguenti soggetti terzi possono accedere a dati raccolti tramite cookie:</p>
            <ul className="list-disc list-inside space-y-1 text-text-dim mt-2">
              <li><strong className="text-text/80">Google LLC</strong> (Google Analytics) — con sede negli USA. Dati trasferiti con garanzie adeguate (clausole contrattuali standard)</li>
              <li><strong className="text-text/80">Meta Platforms, Inc.</strong> (Meta Pixel) — con sede negli USA. Dati trasferiti con garanzie adeguate</li>
              <li><strong className="text-text/80">Vercel Inc.</strong> (hosting) — con sede negli USA</li>
            </ul>
          </section>

          {/* 8. Newsletter */}
          <section>
            <h2 className="font-heading text-xl text-text mb-3">8. Newsletter</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl text-text mb-3">9. Trasferimento Dati Extra-UE</h2>
            <p>
          ...
          {/* 10. Modifiche */}
          <section>
            <h2 className="font-heading text-xl text-text mb-3">10. Modifiche alla Policy</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl text-text mb-3">11. Riferimenti Normativi</h2>
            <ul className="list-disc list-inside space-y-2 text-text-dim">
              ...
              <li>
                <strong className="text-text/80">D.Lgs. 101/2018</strong> — Adeguamento normativa nazionale al GDPR
              </li>
              <li>
              ...
              <li>
                <strong className="text-text/80">Provvedimento Garante n. 231/2021</strong> — Linee guida cookie e altri strumenti di tracciamento
              </li>
            </ul>
          </section>
        </div>
