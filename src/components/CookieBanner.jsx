            ...
            {showPreferences && (
              <div className="space-y-3 mb-4 p-4 bg-bg rounded-xl border border-border">
                ...
                <div className="flex items-center justify-between py-2">
                  <div>
                    <p className="text-text text-sm font-medium">Cookie Tecnici</p>
                    <p className="text-text-dim text-xs">Necessari per il funzionamento del sito</p>
                  </div>
                ...
                <div className="flex items-center justify-between py-2">
                  <div>
                    <p className="text-text text-sm font-medium">Google Analytics</p>
                    <p className="text-text-dim text-xs">Statistiche di visita anonime</p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between py-2">
                  <div>
                    <p className="text-text text-sm font-medium">Meta Pixel</p>
                    <p className="text-text-dim text-xs">Misurazioni pubblicità e remarketing</p>
                  </div>
                  <button
